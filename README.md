...
![Matriz de Seleção](arquivos/matrizSelecao.png)
...
![Tela Mobile 2](arquivos/prototipos/mobile/tela2.png)

**Descrição:**  
[Descreva o objetivo da tela.]

[Adicionar as demais telas.]
...
[Informar a ferramenta e a notação utilizada.]

---

## 7.2 Principais entidades

As três principais entidades identificadas no sistema são:

1. **[Entidade 1]** — [Descrição]
2. **[Entidade 2]** — [Descrição]
3. **[Entidade 3]** — [Descrição]
...
O modelo foi desenvolvido buscando:

- utilizar nomes coerentes para entidades e atributos;
- reduzir informações redundantes;
- minimizar a ocorrência de valores nulos;
- evitar tuplas falsas;
- aplicar os conceitos de normalização;
- manter a coerência entre o modelo e os requisitos do sistema.
...
| Objeto | Descrição |
|---|---|
| **[OBJETO 1]** | [Descrição do objeto] |
| **[OBJETO 2]** | [Descrição do objeto] |
| **[OBJETO 3]** | [Descrição do objeto] |
| **[OBJETO 4]** | [Descrição do objeto] |

### Exemplo

**CLIENTE:** Tabela que armazena as informações relativas ao cliente.

**CPF:** Campo que armazena o número de Cadastro de Pessoa Física
para cada cliente.
...
A rastreabilidade tem como objetivo demonstrar a relação entre
os artefatos produzidos durante o desenvolvimento do projeto,
garantindo que as informações estejam coerentes entre as etapas.

## 9.1 História de Usuário × Protótipo

| História de Usuário | Tela do Protótipo | Objetivo |
|---|---|---|
| HU01 | [Tela] | [Descrição] |
| HU02 | [Tela] | [Descrição] |
| HU03 | [Tela] | [Descrição] |
...
| História de Usuário | Tela | Dados envolvidos | Tabela/Entidade |
|---|---|---|---|
| HU01 | [Tela] | [Dados] | [Tabela] |
| HU02 | [Tela] | [Dados] | [Tabela] |
| HU03 | [Tela] | [Dados] | [Tabela] |

### Observação

Os modelos devem permanecer em conformidade com a
rastreabilidade definida entre histórias de usuário,
protótipos e modelo conceitual.
...
![PMC](arquivos/PMC/PMC.png)

### Descrição

[Descrever o PMC desenvolvido pelo grupo, quando necessário.]

---

## DOCUMENTAÇÃO COMPLEMENTAR

Os arquivos utilizados na construção deste trabalho estão
organizados no diretório [`arquivos/`](arquivos/).
...
- modelo conceitual;
- PMC;
- demais documentos produzidos durante o projeto.
